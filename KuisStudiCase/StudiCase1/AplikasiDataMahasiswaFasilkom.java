package UlanganTengahSemester.StudiCase1;
...
public class AplikasiDataMahasiswaFasilkom {
    public static void main(String[] args) {
        ...
        do {
            ...
            if (pilihan == 1) {
                for (int i = 0; i < 1; i++) { // perulangan for hanya sekali
                    sistemInformasi++;
                    System.out.println("Data kehadiran untuk Sistem Informasi berhasil ditambahkan!");
                }
            } else if (pilihan == 2) {
                for (int i = 0; i < 1; i++) {
                    informatika++;
                    System.out.println("Data kehadiran untuk Informatika berhasil ditambahkan!");
                }
            } else if (pilihan == 3) {
                for (int i = 0; i < 1; i++) {
                    sainsData++;
                    System.out.println("Data kehadiran untuk Sains Data berhasil ditambahkan!");
                }
            } else {
